 ...
 * Author: GEII Robot
 *
 * Created on 4 octobre 2023, 09:37
 */
...
void InitADC1(void) {
    ...
    /************************************************************/
    //ADC utilisés : 35(B0)-47(B8)-48(B9) - 49(B10) - 50(B11)
    ANSELBbits.ANSB0 = 1;
    ANSELBbits.ANSB8 = 1;
    ANSELBbits.ANSB9 = 1;
    ANSELBbits.ANSB10 = 1;
    ...
    AD1CSSLbits.CSS0 = 1; // Enable AN2 for scan 
    AD1CSSLbits.CSS8 = 1; // Enable AN6 for scan 
    AD1CSSLbits.CSS9 = 1; // Enable AN11 for scan
    AD1CSSLbits.CSS10 = 1; // Enable AN15 for scan 
    AD1CSSLbits.CSS11 = 1; // Enable AN16 for scan 
